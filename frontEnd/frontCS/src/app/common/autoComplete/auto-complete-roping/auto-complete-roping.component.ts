...
@Component({
  selector: 'app-auto-complete-roping',
  templateUrl: './auto-complete-roping.component.html',
  styleUrls: ['./auto-complete-roping.component.scss']
})
export class AutoCompleteRopingComponent implements OnInit{
  ...
  constructor(
    ...
    private api                 : AxiosRopingResourceClient,
  ){
  }
